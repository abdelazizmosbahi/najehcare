...
<head>
    ...
    <title>@yield('title', 'NajehCare')</title>
    <link rel="stylesheet" href="{{ asset('css/app.css') }}"> <!-- Include your CSS file -->
    <!-- Include any other required CSS or JS libraries here (Bootstrap, etc.) -->
    ...
    <footer class="footer_section">
      <div class="container">
          ...
          <div class="col-md-6 col-lg-2 mx-auto footer_col">
            <div class="footer_link_box">
              ...
              <div class="footer_links">
                <a class="active" href="{{ route('appointments.index') }}">Appointments</a>
        ...
        <div class="footer-info">
          <p>
            <span id="displayYear"></span> Distributed By <a href="https://themewagon.com/">NajehCare</a>
          </p>
        </div>  
      </div>
    </footer>
